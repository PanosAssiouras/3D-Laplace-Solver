...
!       ***************************************************** 
        ...
        READ(10,*)RES,LJ,PITCH,D,SCALE,Length
...
!       **************************************************
 ...
 334    CONTINUE
        ...
        Write (17,*) 'P1S(K,L,1)=',K,L, P1S(K,1)
        Write (16,*) 'PSS(K,L,1)=',K,L, PSS(K,1)
...
!        *******************************************************
 ...
 553    CONTINUE 
	    ...
	    C02D=C02/C1D
	    C00D=C00/C1D
	    Write(22,*),'Capacitancies normalized to C1D=epsilon*(L/D),'
        WRITE(22,*)'C1D=',C1D,'C00D=',C00D,'C01D=',C01D,'C02D=',C02D
        WRITE(22,*)' '
        IF (ICHK .EQ. 0) GO TO 222
!        Write(22,*),'Capacitancies:','C00= ', C00,'C01= ', C01, 'C02= ',C02
!        Write(22,*),'Capacitancies normalized to C1D=epsilon*(L/D)'
!        WRITE(22,*)'C1D=',C1D,'C00D=',C00D,'C01D=',C01D,'C02D=',C02D
!        WRITE(22,*)' '
        e0=8.854e-6
	    print *,"***Capacitances in pF per micron***"
	    print *," Strip to backplane C00:",            C00*e0
	    print *," Interstrip to first neighbour C01:", C01*e0
	    print *," Interstrip to second neighbour C02:", C02*e0
	    print *, "Preshower Capacitances in pF ", "C00= ", C00*e0*Length, "C01= ", C01*e0*Length, "C02= ",C02*e0*Length
	    totalcap=( C00+2*(C00*C01)/(C00+C01) + 2*ABS(C00*C02)/(C00+C02) )*e0*Length
	    print *, "Total  Capacitance seen by the amplifier per =",Length/10000., "cm   :", totalcap
	    WRITE(33,444) REAL(LJ)/REAL(LJ+PITCH), totalcap
	    444 format (f4.2," ",  f7.3)
